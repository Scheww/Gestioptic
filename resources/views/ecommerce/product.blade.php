...
<!-- Product Detail -->
<div class="container bgwhite p-t-35 p-b-80" style="margin-bottom: 20px">
    <div class="flex-w flex-sb">
        ...
        <div class="w-size14 p-t-30 respon5">
            ...
            <div class="p-t-33 p-b-60">
               <!-- <div class="flex-m flex-w p-b-10">
                    ...
                    <div class="rs2-select2 rs3-select2 bo4 of-hidden w-size16">
                        ...
                        </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 152px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-size-ll-container"><span class="select2-selection__rendered" id="select2-size-ll-container" title="Choose an option">Choose an option</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                    </div>
                </div>-->
                <div class="flex-m flex-w">
                    ...
                    <div class="rs2-select2 rs3-select2 bo4 of-hidden w-size16">
                        <select class="selection-1 select1-hidden-accessible" name="color" tabindex="-1" aria-hidden="true">
            ...
            <div class="p-b-45">
                ...
                <span class="s-text8">Categoria: Ropa</span>
            </div>
