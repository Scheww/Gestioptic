...
<head>
    ...
    <meta name="description" content="Gestioptic">
    <meta content="width=device-width, initial-scale=1, user-scalable=no" name="viewport">

    <title>Gestioptic</title>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('template/propeller/themes/images/favicon.ico')}}">
    ...
    <!-- build:remove -->
    <!-- Bootstrap css -->
    <link rel="stylesheet" type="text/css" href="{{asset('template/propeller/assets/css/bootstrap.min.css')}}">

    <!-- Propeller css -->
    <link rel="stylesheet" type="text/css" href="{{asset('template/propeller/assets/css/propeller.min.css')}}">

    <!-- Propeller theme css-->
    <link rel="stylesheet" type="text/css" href="{{asset('template/propeller/themes/css/propeller-theme.css')}}" />

    <!-- Propeller admin theme css-->
    <link rel="stylesheet" type="text/css" href="{{asset('template/propeller/themes/css/propeller-admin.css')}}">
    ...
    <!-- Propeller admin theme css-->
    <link rel="stylesheet" type="text/css" href="{{asset('template/propeller/themes/css/propeller-admin.css')}}">
    <!-- build:include snippets/css-files-dashboard.html -->
    <!-- /build -->
    ...
    <!-- Canonical Tag -->
    <link rel="canonical" href="http://themes.propeller.in/bootstrap3/html/propeller-admin/" />
    <!-- /build -->
        ...
        <!---<ul class="list-group pmd-list-avatar pmd-card-list">
                            ...
                            <a href="javascript:void(0)">
                                <div class="media-left">
									<span class="avatar-list-img40x40">
										<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="{{asset('template/propeller/themes/images/profile-1.png')}}" data-holder-rendered="true">
									</span>
                                </div>
                        ...
                        <li class="list-group-item">
                            <a href="javascript:void(0)">
                                <div class="media-left">
									<span class="avatar-list-img40x40">
										<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="{{asset('template/propeller/themes/images/profile-2.png')}}" data-holder-rendered="true">
									</span>
                                </div>
                                <div class="media-body">
                        ...
                        <li class="list-group-item unread">
                            <a href="javascript:void(0)">
                                <div class="media-left">
									<span class="avatar-list-img40x40">
										<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="{{asset('template/propeller/themes/images/profile-3.png')}}" data-holder-rendered="true">
									</span>
                                </div>
                        ...
                        <li class="list-group-item unread">
                            <a href="javascript:void(0)">
                                <div class="media-left">
									<span class="avatar-list-img40x40">
										<img alt="40x40" data-src="holder.js/40x40" class="img-responsive" src="{{asset('template/propeller/themes/images/profile-4.png')}}" data-holder-rendered="true">
									</span>
                                </div>
                                <div class="media-body">
    ...
    <ul class="nav pmd-sidebar-nav">
        ...
        <li class="dropdown pmd-dropdown pmd-user-info visible-xs visible-md visible-sm visible-lg">
            <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" aria-expandedhref="javascript:void(0);">
                <div class="media-left">
                    <img src="{{asset('template/propeller/themes/images/user-icon.png')}}" alt="New User">
                </div>
                <div class="media-body media-middle">{{ request()->user->name }}</div>
	...
	c0,0,0.616-0.945,0.616-1.001c0.168-0.281,0.334-0.626,0.334-1.02C7.875,0.733,7.144,0.002,6.188,0.001L6.188,0.001z"/>
        ...
        <li class="dropdown pmd-dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="{{route('sales-index')}}">Listado de ventas</a></li>
            </ul>
        </li>
        <li class="dropdown pmd-dropdown">
            <a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">
...
<path fill="#C9C8C8" d="M0,0v18h14.187V0H0z M3.121,3.293h2.023v4.767H3.121V3.293z M11.211,14.764H2.948v-2.022h8.263V14.764
	...
	H7.455V3.207h3.756V5.229z"/>
            ...
            <ul class="dropdown-menu">
                <li><a href="{{route('config-optics')}}">Opticas</a></li>
                <li><a href="{{route('config-users')}}">Usuarios</a></li>
                <li><a href="{{route('config-brands')}}">Marcas</a></li>
                <li><a href="{{route('config-types')}}">Tipo de productos</a></li>
            </ul>
        </li>
...
<!-- build:include snippets/js-files-dashboard.html -->
<!-- /build -->
...
<script src="{{asset('template/propeller/assets/js/jquery-1.12.2.min.js')}}"></script>
<script src="{{asset('template/propeller/assets/js/bootstrap.min.js')}}"></script>
<script src="{{asset('template/propeller/assets/js/propeller.min.js')}}"></script>
<!-- /build -->
