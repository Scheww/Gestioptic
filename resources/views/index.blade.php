                        ...
                        <div class="pmd-card-body statistics text-center">
                            <ul class="list-group list-inline">
                                <li>
                                    ...
                                    <div class="pmd-display2">+70</div>
                                    <div class="source-semibold typo-fill-secondary">Productos</div>
                                </li>
                                <li>
                                    <div class="statistic-img-circle">
                                    ...
                                    <div class="source-semibold typo-fill-secondary">Recetas</div>
                                </li>
                                <li>
                                    <div class="statistic-img-circle">
                                    ...
                                    <div class="pmd-display2">57</div>
                                    <div class="source-semibold typo-fill-secondary">Ventas</div>
                                </li>
                                <li>
                                    <div class="statistic-img-circle">
                                    ...
                                    <div class="pmd-display2">+90</div>
                                    <div class="source-semibold typo-fill-secondary">Clientes Contentos</div>
                                </li>
                                <li>
                                    <div class="statistic-img-circle">
                                    ...
                                    <div class="source-semibold typo-fill-secondary">Empleados</div>
                                </li>
                                <!--<li>
                                    <div class="statistic-img-circle">
                                    ...
                                    <div class="source-semibold typo-fill-secondary">Fallas</div>
                                </li>-->
                            </ul>
                        </div>
